...
const AddAdminMain = () => {
  ...
  return (
    <div className="bg-[#36393e52] rounded-[.5rem] w-full md:w-2/3 lg:w-1/2 p-3 m-auto my-5">
      <div className="pt-5 ">
        ...
        >
          <input
            ...
            className="text-xl bg-auto text-black p-2 border-slate-500 border rounded-lg w-full"
            type="email"
            onBlur={handleOnBlur}
          />
          <br />
